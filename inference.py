...
starGAN_model_path = 'Models/epoch_00150.pth'
starGAN_model_config = 'Models/config.yml'
...
wav_path = '/home/c95yyw/StarGANv2-VC/SI_3.wav'
...
for key, (ref, _) in reference_embeddings.items():
    with torch.no_grad():
        ...
        sf.write('./test_winnie_' + str(key) + '.wav', y_out, 24000)
